...
class SublistConfig extends FixedConfig
{
    ...
    protected $providers = [
        ...
        'renderInput' => '\\CsvMigrations\\FieldHandlers\\Provider\\RenderInput\\SublistRenderer',
        ...
        'validationRules' => '\\CsvMigrations\\FieldHandlers\\Provider\\Validation\\ListValidationRules',
    ];
}
