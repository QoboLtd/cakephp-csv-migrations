...
/**
 * HasManyValidationRules
 *
 * This class provides the validation rules for the has_many field type.
 */
class HasManyValidationRules extends AbstractValidationRules
{
    /**
     * {@inheritDoc}
     */
