    ...
    public function renderInputsProvider()
    {
        return [
            [
                ...
                'balance' => '<label for="balance">Balance</label><div class="form-group number"><input type="number" name="Foo[balance]" step="any" max="0" id="foo-balance" class="form-control" value="8.6727"/></div>'
            ]
        ];
    }
}
