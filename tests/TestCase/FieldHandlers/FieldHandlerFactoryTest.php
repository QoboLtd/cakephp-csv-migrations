    ...
    public function renderInputsProvider()
    {
        return [
            [
                ...
                'balance' => '<div class="form-group number"><label class="control-label" for="foo-balance">Balance</label><input type="number" name="Foo[balance]" id="foo-balance" class="form-control" value="6727"/></div>'
            ]
        ];
    }
}
