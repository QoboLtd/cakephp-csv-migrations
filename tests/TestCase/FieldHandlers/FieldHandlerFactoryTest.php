    ...
    public function renderInputsProvider()
    {
        return [
            [
                ...
                'cost' => '<label for="cost">Cost</label><div class="row"><div class="col-xs-6 col-lg-4"><div class="form-group number"><input type="number" name="Foo[cost_amount]" step="any" max="999999.99" id="foo-cost-amount" class="form-control" value="1000.1"/></div></div><div class="col-xs-6 col-lg-4"><div class="form-group"><select name="Foo[cost_currency]" class="form-control"><option value="eur" selected="selected">EUR</option><option value="usd">USD</option><option value="gpb">GPB</option></select></div></div></div>',
                ...
                'garden_area' => '<label for="garden-area">Garden Area</label><div class="row"><div class="col-xs-6 col-lg-4"><div class="form-group number"><input type="number" name="Foo[garden_area_amount]" step="any" max="999999.99" id="foo-garden-area-amount" class="form-control" value="50.1"/></div></div><div class="col-xs-6 col-lg-4"><div class="form-group"><select name="Foo[garden_area_unit]" class="form-control"><option value="m" selected="selected">m&amp;sup2;</option><option value="ft">ft&amp;sup2;</option></select></div></div></div>',
                ...
                'start_time' => '<div class="form-group time"><label class="control-label">Start Time</label><ul class="list-inline"><li class="year"></li><li class="month"></li><li class="day"></li><li class="hour"><select name="Foo[start_time][hour]" class="form-control"><option value="00">0</option><option value="01">1</option><option value="02">2</option><option value="03">3</option><option value="04">4</option><option value="05">5</option><option value="06">6</option><option value="07">7</option><option value="08">8</option><option value="09">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16" selected="selected">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option></select></li><li class="minute"><select name="Foo[start_time][minute]" class="form-control"><option value="00">00</option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15" selected="selected">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option></select></li><li class="second"></li><li class="meridian"></li></ul></div>',
                'balance' => '<label for="balance">Balance</label><div class="form-group number"><input type="number" name="Foo[balance]" step="any" max="99999999.9999" id="foo-balance" class="form-control" value="8.6727"/></div>'
            ]
        ];
    }
}
