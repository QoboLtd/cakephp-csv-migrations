...
use CsvMigrations\FieldHandlers\Provider\FieldToDb\BooleanFieldToDb;
use PHPUnit_Framework_TestCase;

class BooleanFieldToDbTest extends PHPUnit_Framework_TestCase
{
    protected $provider;
    ...
    protected function setUp()
    {
        ...
        $this->provider = new BooleanFieldToDb($config);
    }
    ...
    public function testProvide()
    {
        ...
        $this->assertEquals('boolean', $result['foobar']->getType(), "DbField type is incorrect");
    }
