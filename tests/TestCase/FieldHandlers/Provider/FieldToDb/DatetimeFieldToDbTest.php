...
use CsvMigrations\FieldHandlers\Provider\FieldToDb\DatetimeFieldToDb;
use PHPUnit_Framework_TestCase;

class DatetimeFieldToDbTest extends PHPUnit_Framework_TestCase
{
    protected $provider;
    ...
    protected function setUp()
    {
        ...
        $this->provider = new DatetimeFieldToDb($config);
    }
    ...
    public function testProvide()
    {
        ...
        $this->assertEquals('datetime', $result['foobar']->getType(), "DbField type is incorrect");
    }
