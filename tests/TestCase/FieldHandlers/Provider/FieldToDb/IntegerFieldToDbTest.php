...
use CsvMigrations\FieldHandlers\Provider\FieldToDb\IntegerFieldToDb;
use PHPUnit_Framework_TestCase;

class IntegerFieldToDbTest extends PHPUnit_Framework_TestCase
{
    protected $provider;
    ...
    protected function setUp()
    {
        ...
        $this->provider = new IntegerFieldToDb($config);
    }
    ...
    public function testProvide()
    {
        ...
        $this->assertEquals('integer', $result['foobar']->getType(), "DbField type is incorrect");
    }
