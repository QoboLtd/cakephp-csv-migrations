...
use CsvMigrations\FieldHandlers\Provider\FieldToDb\ListFieldToDb;
use PHPUnit_Framework_TestCase;

class ListFieldToDbTest extends PHPUnit_Framework_TestCase
{
    protected $provider;
    ...
    protected function setUp()
    {
        ...
        $this->provider = new ListFieldToDb($config);
    }
    ...
    {
        $csvField = new CsvField(['name' => 'foobar', 'limit' => 'list(foo)']);
        ...
        $this->assertEquals('string', $result['foobar']->getType(), "DbField type is incorrect");
        $this->assertEquals(255, $result['foobar']->getLimit(), "DbField limit is incorrect");
    }
