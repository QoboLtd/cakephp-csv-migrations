...
use CsvMigrations\FieldHandlers\Provider\RenderValue\NumberRenderer;
use PHPUnit_Framework_TestCase;
use StdClass;

class NumberRendererTest extends PHPUnit_Framework_TestCase
{
    protected $renderer;

    protected function setUp()
    {
        $config = new NumberConfig('number');
        $this->renderer = new NumberRenderer($config);
    }
